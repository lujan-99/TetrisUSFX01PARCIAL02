...
#include "Bul_ConstructorPieza02.generated.h"

UCLASS()
class TETRISUSFX01_API ABul_ConstructorPieza02 : public AActor, public IBul_ConstructorPieza
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ABul_ConstructorPieza02();
private:

...
#include "Bul_ConstructorPieza01.generated.h"

UCLASS()
class TETRISUSFX01_API ABul_ConstructorPieza01 : public AActor, public IBul_ConstructorPieza
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ABul_ConstructorPieza01();
private:

...
#include "Bul_ConstructorPieza03.generated.h"

UCLASS()
class TETRISUSFX01_API ABul_ConstructorPieza03 : public AActor, public IBul_ConstructorPieza
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ABul_ConstructorPieza03();
private:

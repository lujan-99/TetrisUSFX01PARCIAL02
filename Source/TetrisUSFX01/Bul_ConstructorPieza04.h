...
#include "Bul_ConstructorPieza04.generated.h"

UCLASS()
class TETRISUSFX01_API ABul_ConstructorPieza04 : public AActor, public IBul_ConstructorPieza
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ABul_ConstructorPieza04();
private:
